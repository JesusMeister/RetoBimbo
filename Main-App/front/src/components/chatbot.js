...
const BimboChatBot = () => {
  ...
  return (
    <div>
    <div className="text-2xl font-bold text-left rounded-t-lg text-white bg-blue-800 p-4">Bimbot</div>
    <div className="bg-white shadow-md rounded-b-lg p-6 max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex mt-4">
        ...
        <button
          type="submit"
          className="bg-blue-800 text-white px-4 rounded-r-lg hover:bg-blue-600 transition duration-300"
          disabled={isLoading}
        >
          Enviar
        </button>
